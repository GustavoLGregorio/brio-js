...
import { BrioRender } from "./game/BrioRender.js";
import { BrioDebugger } from "./game/BrioDebugger.js";
...
export class BrioGame {
	...
	constructor(width, height, appendToElement, canvasContextSettings = {}) {
		...
		this.#debugger = new BrioDebugger();
