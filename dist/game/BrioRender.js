export class BrioRender {
    ...
    renderObject(object) {
        ...
        this.#ctx.drawImage(object.sprite.element, translated ? -object.transform.size.x * object.transform.pivot.x : 0, translated ? -object.transform.size.y * object.transform.pivot.y : 0, object.transform.size.x, object.transform.size.y);
        this.#ctx.restore();
    }
