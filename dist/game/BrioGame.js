...
import { BrioRender } from "./BrioRender.js";
...
export class BrioGame {
    ...
    constructor(width, height, appendToElement, canvasContextSettings = {}) {
        ...
        this.#render = new BrioRender(this, this.#loadedGameObjects, this.ctx, this.#scale, this.#width, this.#height, this.#gameLastFPS);
    ...
    instantiate(targetObject) {
        ...
        // cloning object
        const newObject = new BrioObject(`${targetObject.name}-${targetObject.clonesInstantiatedValue + 1}`, targetObject.sprite, targetObject.transform.layer);
