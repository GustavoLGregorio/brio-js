...
export class Game {
	...
	public instantiate(targetObject: GameObject, quantity: number = 1): GameObject[] {
	...
	public colliding(object1: GameObject, object2: GameObject): boolean {
		if (
			typeof object1.collision.x === "number" &&
			...
			if (
				object1.pos.x <= object2.pos.x + object2.collision.w &&
